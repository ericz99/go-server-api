...
import (
	...
	service "go-server-api/app/service/api/v2"

	"github.com/gorilla/mux"
	"github.com/jinzhu/gorm"
)

// GetBookStatusRoute Controller Route
func GetBookStatusRoute(w http.ResponseWriter, r *http.Request) {
	// # set header as content type json format
	w.Header().Set("Content-Type", "application/json")
	json.NewEncoder(w).Encode(models.Response{Status: "GOOD", Message: "Hit API V2 Endpoint!"})
}
